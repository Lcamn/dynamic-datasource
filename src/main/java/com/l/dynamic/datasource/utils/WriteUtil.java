...
public class WriteUtil {
    public static void main(String[] args) throws IOException {
        ...
        // 存放文件的目录
        final String filepath1 = "E:\\临时文件夹\\测试写文件\\write1.txt";
        final String filepath2 = "E:\\临时文件夹\\测试写文件\\write2.txt";
        final String filepath3 = "E:\\临时文件夹\\测试写文件\\write3.txt";
        final String filepath4 = "E:\\临时文件夹\\测试写文件\\write4.txt";
        final String filepath5 = "E:\\临时文件夹\\测试写文件\\write5.txt";
        final String filepath6 = "E:\\临时文件夹\\测试写文件\\write6.txt";
     ...
     * @throws IOException
     */
    public static void bufferedOutputStreamTest(String filepath, String content) throws IOException {
     ...
     * @throws IOException
     */
    public static void fileOutputStreamTest(String filepath, String content) throws IOException {
     ...
     * @throws IOException
     */
    public static void printWriterTest(String filepath, String content) throws IOException {
     ...
     * @throws IOException
     */
    public static void bufferedWriterTest(String filepath, String content) throws IOException {
     ...
     * @throws IOException
     */
    public static void fileWriterTest(String filepath, String content) throws IOException {
