        ...
        <vertical>
            ...
            <viewpager id="viewpager">
                <frame>
                    <ScrollView>
                        <vertical>
                            <button text="先点我开启无障碍和悬浮窗,如果没有反应，说明已经开启" style="Widget.AppCompat.Button.Colored"
                                    id="click_me" w="*"/>
                            ...
                            <button text="-------以下为单个任务执行-------" style="Widget.AppCompat.Button.Borderless.Colored"
                                    w="*"/>
                            ...
                            <button id="sauc" w="*" text="切换账户执行(为每个账户执行选中的内容)"
                                    style="Widget.AppCompat.Button.Colored"/>

                            <button text="-------公告-------" style="Widget.AppCompat.Button.Borderless.Colored" w="*"/>
                            <button text="此应用仅适用于Android7.0以上！" style="Widget.AppCompat.Button.Borderless.Colored"
                                    w="auto"/>
                ...
                <frame>
                    <vertical>
                        ...
                        <progressbar id="pbar" indeterminate="true"
